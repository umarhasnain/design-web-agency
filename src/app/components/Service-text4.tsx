  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Humanizing Your <br />
          <span style={{ color: "#3092ff" }}>Brand</span>
        </h1>
        ...
        >
          Our experience over the years of serving the industry has taught us that
          visual content influences your business at a greater extent if humanized.
          This can be done by explaining your customers what your business is about
          and how it can benefit them. What better way to explain anyone about a
          complicated business model than an elegantly crafted explainer video. Our
          skilled animators generate different categories of video animations
          including 2D animations, whiteboard animations, testimonial videos, as
          well as typography animations.
        </p>
